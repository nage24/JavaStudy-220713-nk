...
public class Method1 {
	...
	public static void printData(String data) { 	// 매개변수
		while(true) {		
	...
	public static void main(String[] args) { 
		String data = "@Message:안녕하세요.@To:김준일@From:김준일@SendDate:2022/07/21"; 	// 지역변수
		String data2 = "@Message:안녕하세요.@To:김준일@From:김준일@SendDate:2022/07/21";
		String data3 = "@Message:안녕하세요.@To:김준일@From:김준일@SendDate:2022/07/21";
